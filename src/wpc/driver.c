...
DRIVERNV(victr101)      //                Victory (1.01 tournament/competition MOD)
DRIVERNV(victr11)       //                Victory (1.1 tournament/competition MOD)
DRIVERNV(victr12)       //          03/25 Victory (1.2 tournament/competition MOD)
DRIVERNV(victr13)       //          06/25 Victory (1.3 tournament/competition MOD)
...
DRIVERNV(smbv1)         //                Super Mario Bros. (Spanish / Vifico license) (rev.1)
DRIVERNV(smbv2)         //                Super Mario Bros. (Spanish / Vifico license) (most likely rev.2)
...
DRIVER  (mav,404g)      //             01/95 Maverick, The Movie (4.04 German, 4.00 Display)
...
DRIVER  (bay,402)       //             12/25 Baywatch (4.02) (unofficial MOD)
...
DRIVER(pb,j5)           //          01/26   Pin-Bot (PEMBOT (no relation) J-5)
...
DRIVER(tsptr,lx4)       //          12/25   Transporter the Rescue (LX-4 Tournament MOD)
...
DRIVER(bcats,f1)        //S11-575:  11/89 W Bad Cats (LF-1 French)
DRIVER(bcats,l2)        //          11/89 W Bad Cats (LA-2)
DRIVER(bcats,g4)        //          11/89 W Bad Cats (LG-4 German)
...
DRIVER(diner,l4fr)      //          12/25   Diner (LA-4 Fixed Right Ramp MOD)
...
DRIVER(tafg,da2)        //                  Addams Family Special Collectors Edition / Gold, The (DA-2) LED Ghost Fix
DRIVER(tafg,la3)        //          10/94 B Addams Family Special Collectors Edition / Gold, The (LA-3)
DRIVER(tafg,da3)        //                  Addams Family Special Collectors Edition / Gold, The (DA-3) LED Ghost Fix
